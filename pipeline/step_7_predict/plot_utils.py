...
def plot_classification_probs_gcs(
    ...
    """
    Create and save a horizontal bar chart of classification probabilities to GCS.
    ...
    Args:
        ...
        plot_gcs_path: GCS path where the plot will be saved
    ...
    Returns:
        True if plot was created and uploaded successfully, False otherwise
    """
    try:
        ...
        plt.close('all')
        raise Exception(f"Failed to create classification probability plot (GCS): {str(e)}")
...
def plot_classification_probs(
    ...
    """
    Legacy compatibility function - creates classification probability plot and saves locally.
    
    Args:
        prob_series_or_df: Probabilities data
...
def plot_regression_hist_gcs(
    ...
    """
    Create and save a histogram/KDE of training target values with a vertical line for prediction to GCS.
    ...
    try:
        ...
        # Clean up any open figures
        plt.close('all')
        raise Exception(f"Failed to create regression histogram plot (GCS): {str(e)}")
...
def plot_regression_hist(
    ...
    """
    Legacy compatibility function - creates regression histogram and saves locally.
...
def create_prediction_summary_plot_gcs(
    ...
    """
    Create a summary visualization based on task type and save to GCS.
    ...
    try:
        ...
        plt.close('all')
        raise Exception(f"Failed to create prediction summary plot (GCS): {str(e)}")
...
def create_prediction_summary_plot(
    ...
    """
    Legacy compatibility function - creates summary visualization and saves locally.
